...
const COPY = {
    ...
    en: {
        ...
        managerLabel: '02 / Project manager', managerName: 'Sergey Maklakov', managerRole: 'Project manager · Memora Solutions', managerLead: 'Sergey connects the client objective and the team’s work in a transparent process.',
