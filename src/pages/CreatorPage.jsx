...
function getExperienceYears() {
    const start = new Date(2019, 9, 1); // October 2019 (month is 0-indexed)
    const now = new Date();
...
export default function CreatorPage() {
    ...
    const years = useMemo(() => getExperienceYears(), []);
    ...
    return (
        <div className="creator-page">
            ...
            <section className="creator-hero">
                ...
                <div className="container creator-hero__inner">
                    ...
                    >
                        ...
                        <p className="creator-hero__lead">{t('creator.heroLead', { years })}</p>
                    </motion.div>
            ...
            <div className="container creator-page__body">
                ...
                {/* ═══════════════ CONTACT INFO (duplicated from CTA) ═══════════════ */}
                <AnimatedSection>
                    <section className="creator-contact-top">
                        <div className="creator-contact-top__links">
                ...
                <AnimatedSection>
                    <section className="creator-section creator-intro">
                        ...
                        <p className="creator-text" dangerouslySetInnerHTML={{ __html: t('creator.introText', { years }) }} />
                    </section>
                </AnimatedSection>
                ...
                <AnimatedSection>
                    <section className="creator-numbers">
                        <div className="creator-numbers__card">
                            ...
                            <span className="creator-numbers__value">{t('creator.num1Value', { years })}</span>
