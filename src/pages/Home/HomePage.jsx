    ...
    const products = [
        {
            ...
            to: '/travel-radar',
            color: 'gold',
            logo: staticAsset('/travel-logo.webp?v=2'),
        },
        {
            icon: <Wallet size={32} />,
            ...
            to: '/wallet',
            color: 'green',
            logo: staticAsset('/wallet-logo.webp?v=2'),
        },
        {
            icon: <Cake size={32} />,
            ...
            to: '/bday-bot',
            color: 'blue',
            logo: staticAsset('/bdaybot-logo.webp?v=2'),
        },
        {
            icon: <Timer size={32} />,
            ...
            to: '/pomodoro',
            color: 'orange',
            logo: staticAsset('/pomodoro-logo.webp?v=2'),
        },
    ];
