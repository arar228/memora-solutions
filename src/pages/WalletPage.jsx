...
import { Wallet, Send, CheckCircle, ArrowRight } from 'lucide-react';
            ...
            <div className="container">
                <AnimatedSection>
                    <div className="product-page__header">
                        ...
                        >
                            <Send size={16} /> {t('openBot')} {t('products.wallet.bot')}
                        </a>
                    </div>
                </AnimatedSection>
                ...
                <div className="product-page__content">
                    <AnimatedSection delay={0.1}>
                        <div className="product-section card">
                            <h2>{t('products.wallet.features.title')}</h2>
