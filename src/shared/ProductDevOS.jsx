...
function TemplateEditorModal({template,onClose,onSave,isNew}) {
  ...
  return(
    <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.7)",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center",overflow:"auto"}} onClick={onClose}>
...
function NewProjectModal({templates,onClose,onCreate}) {
  ...
  return(
    <div style={{position:"absolute",inset:0,background:"rgba(0,0,0,0.7)",zIndex:500,display:"flex",alignItems:"center",justifyContent:"center"}} onClick={onClose}>
...
function Toast({msg,vis}){return (<div style={{position:"absolute",bottom:20,left:"50%",transform:`translateX(-50%) translateY(${vis?0:20}px)`,opacity:vis?1:0,background:T.accent,color:"#fff",padding:"7px 16px",borderRadius:7,fontSize:11,fontFamily:SANS,fontWeight:600,boxShadow:"0 4px 20px rgba(0,0,0,0.4)",transition:"all 0.3s",pointerEvents:"none",zIndex:999}}>{msg}</div>);}
...
export default function App() {
  ...
  return(
    <div style={{minHeight:"600px",background:T.bg,padding:"20px 12px",fontFamily:SANS}}>
